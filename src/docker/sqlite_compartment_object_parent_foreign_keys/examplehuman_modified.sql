...
FOREIGN KEY ( ImageNumber ) REFERENCES Per_Image ( ImageNumber ),
FOREIGN KEY ( Cells_Parent_Nuclei ) REFERENCES Per_Nuclei ( Nuclei_Number_Object_Number ),
...
FOREIGN KEY ( ImageNumber ) REFERENCES Per_Image ( ImageNumber ),
FOREIGN KEY ( Cytoplasm_Parent_Cells ) REFERENCES Per_Cells ( Cells_Number_Object_Number ),
FOREIGN KEY ( Cytoplasm_Parent_Nuclei ) REFERENCES Per_Nuclei ( Nuclei_Number_Object_Number ),
...
FOREIGN KEY ( ImageNumber ) REFERENCES Per_Image ( ImageNumber ),
FOREIGN KEY ( PH3_Parent_Nuclei ) REFERENCES Per_Nuclei ( Nuclei_Number_Object_Number ),
